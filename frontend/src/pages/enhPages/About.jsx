          ...
          <Row className="align-items-center">
            ...
            <Col lg={6} className="about-image">
              ...
              <motion.div className="about-stats-row" variants={staggerSm}>
                {[
                  { val: 100, sfx: "+", label: "Happy Clients" },
                  { val: 99, sfx: "%", label: "Client Satisfaction" },
                  { val: 15, sfx: "+", label: "Industries Served" },
                ].map((s, i) => (
        ...
        <Container className="text-center">
          <motion.div initial="hidden" whileInView="show" viewport={vp} variants={stagger}>
            <motion.div variants={fadeUp} className="about-eyebrow-tag mx-auto mb-3" style={{ color: "rgb(235,174,95)" }}>
              <span className="aet-dot" />Why ENH Consulting
            </motion.div>
                  ...
                  <motion.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.96 }}>
                    <Button className="cta-btn" onClick={handleCta}
                      ...
                      <AnimatePresence mode="wait">
                        ...
                        {(ctaStatus === "idle") && <motion.span key="i" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>Submit</motion.span>}
                      </AnimatePresence>
                    </Button>
                  </motion.div>
                </Form>
