...
import serviceHeroBannerBusiness from "../../../public/serviceHeroBannerBusiness.webp";
...
function HeroBanner({ data }) {
    ...
    return (
        <section className="svp-hero" style={{ backgroundImage: `url(${serviceHeroBannerBusiness})`, backgroundSize: "cover", backgroundPosition: "center", position: "relative", overflow: "hidden" }}>
            <div style={{
                position: "absolute",
                inset: 0,
                    ...
                    <Col lg={5}>
                        <motion.div initial="hidden" whileInView="show" viewport={vpMd}
                            ...
                            <motion.h2 className="svp-faq__title" variants={fadeLeft}>
                                Frequently Asked Questions About Business Consulting in Dubai
                            </motion.h2>
                            ...
                            <motion.p className="svp-faq__lead" variants={fadeUp}>
                                Everything you need to know before partnering with a business consulting firm in Dubai.
                            </motion.p>
