...
import serviceHeroBannerEdTech from "../../../public/serviceHeroBannerEdTech.webp";
...
function WhyUsSection({ data }) {
    return (
        <section className="svp-whyus">
            ...
            <Container>
                <motion.div initial="hidden" whileInView="show" viewport={vpMd} variants={stagger}>
                    <Eyebrow gold>Why Choose ENH</Eyebrow>
                    ...
                    <Col lg={5}>
                        <motion.div initial="hidden" whileInView="show" viewport={vpMd}
                            ...
                            <motion.p className="svp-faq__lead" variants={fadeUp}>
                                Everything you need to know before partnering with an edTech consulting firm in Dubai.
                            </motion.p>
...
// ─── ROOT ─────────────────────────────────────────────────────────────────────
export default function EdTechConsultancy() {
