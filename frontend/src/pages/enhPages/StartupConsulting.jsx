...
import serviceHeroBannerStartup from "../../../public/serviceHeroBannerStartup.webp";
import {
...
function HeroBanner({ data }) {
    ...
    return (
        <section className="svp-hero" style={{backgroundImage:`url(${serviceHeroBannerStartup})`, backgroundSize: "cover", backgroundPosition: "center", position: "relative", overflow: "hidden"}}>
            <div style={{
                position: "absolute",
                inset: 0,
